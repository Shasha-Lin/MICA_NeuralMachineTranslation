# uses code from file https://github.com/nyu-dl/dl4mt-c2c/blob/master/bpe2char/train_bi_bpe2char.py
# there's no theano here, just some potential changes based on our application
