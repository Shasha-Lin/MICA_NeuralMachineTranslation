...
python3 -u main_model.py --use_cuda --n_iters 200000 --learning_rate 0.001  --main_data_dir "/scratch/eff254/NLP/Data/Model_ready/" --out_dir "/scratch/eff254/NLP/ModelOutputs/"
