...
python3 -u main_model_BS.py --use_cuda --n_iters 800000 --learning_rate 0.001 --teacher_forcing_ratio 0.9  --main_data_dir "/scratch/eff254/NLP/Data/Model_ready/" --out_dir "/scratch/eff254/NLP/ModelOutputs/"