...
parser.add_argument('--MAX_LENGTH', type=int, default=50, help='Max Length of sequence (Input side)')
parser.add_argument('--MIN_LENGTH_TARGET', type=int, default=5, help='Min Length of sequence (Output side)')
parser.add_argument('--MAX_LENGTH_TARGET', type=int, default=50, help='Max Length of sequence (Output side)')
...
input_lang.trim(min_count = 2)
output_lang.trim(min_count = 2)
keep_pairs = []
