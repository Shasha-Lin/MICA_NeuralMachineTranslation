...
python3 -u main_model_BS.py --n_epochs 800000 --learning_rate 0.001 --teacher_forcing_ratio 0.9  --model_type "bpe2bpe" --main_data_dir "/scratch/eff254/NLP/Data/Model_ready/" --out_dir "/scratch/ak6201/NLP/ModelOutputs/"
